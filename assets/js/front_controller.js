...
var locurl = getAbsolutePath()+'/pigeon/';
...
function add_race () {
	...
	rowno=rowno * 10;
	var select = '<select class="form-control bird_type" id="select_bird_type'+rowno+'" name="select_bird_type[]" onchange="check_val(this);"><option value="">Select Bird Category</option>';
	...
	var add_race = '<div class="panel panel-default race_add" id="race_add'+rowno+'">' +
		...
		'<input type="text" class="form-control race_distance" name="bird_distance[]" id="bird_distance'+rowno+'" value="" placeholder="Enter The KM">' +
		'</div>' +
		'<div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">' +
		'<label>Bird Category</label>'+select+'' +
		'</div>' +
		'<div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">' +
		'<label>Bird Tag Color</label><select class="form-control bird_tag_color" id="select_bird_tag_color'+rowno+'" name="select_bird_tag_color[]" onchange="check_tag_color(this);"><option value="">Select Bird Tag Color</option></select>' +
		'</div>	' +
		'</div>' +
		'</div>' +
		'<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12"> ' +
...
function add_more_race (id) {
	...
	$('.remove'+id+rowno).on('click',function(){
		...
		$("#add_more"+id+rowno).prop("disabled",false);
	});
}
...
function add_more () {
	...
	// var ChangeCatDate = Date.parse($(".dateChangeCat").last().val());
	var lastChangeCatDate = $(".dateChangeCat").last().val();
	var end_last_date = $("#event_end_date").val();
	var current_end_race_date = $(".end_race_date").val();
	...
	if(current_end_race_date == lastChangeCatDate)
	{
		alertmsg("Your Date should be with in end date");
		$("#add-more").prop("disabled",true);
		//$("#event_end_date").attr("readonly",true);

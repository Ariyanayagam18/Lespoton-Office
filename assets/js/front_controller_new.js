...
function add_race () {
	...
	rowno=rowno * 10;
	var select = '<select class="form-control bird_type" id="select_bird_type'+rowno+'" name="select_bird_type[]"><option value="">Select Bird Type</option>';

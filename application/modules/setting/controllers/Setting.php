  ...
  /**
	...
	public function index() {   
		...
		if(setting_all('UserModules')=='yes') {
			if(isset($this->session->get_userdata()['user_details'][0]->user_type) && $this->session->get_userdata()['user_details'][0]->user_type=='admin' || $this->session->get_userdata()['user_details'][0]->user_type=='Admin') {
				$data['result'] = $result;

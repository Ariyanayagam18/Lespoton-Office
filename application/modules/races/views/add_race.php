...
<?php foreach ($org_list as $item) {
	// if($item->Org_code != ""){
	?>
		                               <option value="<?php echo $item->users_id;?>"><?php echo $item->name;
	?></option>
	<?php //}
}
?>
                ...
                <div class="panel-heading">
                  ...
                  <div class="col-md-10 col-lg-10 col-sm-10 col-xs-10"></div>
                          ...
                          <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                            ...
                            <select class="form-control bird_type" id="select_bird_type" name="select_bird_type[]">
                              <option value="">Select Bird Type</option>
<?php
foreach ($bird_list as $key => $value) {
	?>
		                                  <option value="<?php echo $value->b_id;?>"><?php echo $value->brid_type;
	?></option>
	<?php
}
?>

	                            ...
	                            <div class="row">
	                              ...
	                              <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12" style="padding-bottom: 10px;">
	                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
	                                  ...
	                                  <input type="text" class="form-control" readonly="" name="race_distance[]" id="race_distance<?php echo $ed_id;?>" value="<?php echo $eve_details->race_distance;?>">
	                                </div>
	                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
	                                ...
	                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12" >
	                                  <div style="display: flex;margin-top: 10px;margin-top: 10px;">
	                                   ...
	                                   <!--  <div id="update<?php //echo $ed_id;?>">
	                                    ...
	                                    <button type="button" class="btn btn-danger" id="view_delete<?php echo $ed_id;?>" value="" onclick="event_dalete('<?php echo $ed_id;?>','<?php echo $id;?>')">Delete</button>
...
<script>
  ...
  $(document).ready(function(){
     ...
     $("#updateRaceform").click(function ( ) {
      ...
      $.ajax({
           type: "post",
           url:locurl+"races/update_category",
           cache: false,
           data: form_data,

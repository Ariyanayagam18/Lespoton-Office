      ...
      <div class="col-xs-12">
        <div class="box box-success">
          <div class="box-header with-border">
            <h3 class="box-title">Pigeon Sticker Colors</h3>
            <div class="box-tools">
            </div>
          </div>
                   ...
                   <tr>
                     <td align="center">
                        <table cellspacing="5" cellpadding="5" border="0" width="50%">
                             <tr>
                               <td align="right">
                                <span><label><b>Sticker Color Name:</b></label></span>
                               </td>
                               <td>
          ...
          <div class="box-body">            
            <table id="example1" class="cell-border example1 table table-striped table1 delSelTable">
              <thead>
                <tr>
                  <th width="10%">S.no</th>
                  <th width="80%">Sticker Color Name</th>
...
$('#cp2').colorpicker({  color: '#0000ff', });
  $(document).ready(function() {  
    ...
    { "orderable": false, "targets": 1 }
          ...
          "processing": true,
          "serverSide": true,
          "ajax": {"url" : url+"user/stickerColor","data" : {"ides":0} },
...
function addeditcolor()
{
    ...
    if(colorname == '')
    {
      alertmsg("Please Enter Sticker Color Name!.");
      return false;
    }
    ...
    {
      type: "post",
      url: url+"user/stickercoloraddedit",
      cache: false,   
      ...
      {  
        ...
        if(json == "dup")
        {
          alertmsg("This sticker color name already exist!");
          $('#example1').DataTable().ajax.reload( null, false );
        }else{
          $('#colorname').val('')
          $('#buttontext').html('ADD')

...
$filepath = base_url();
    ...
    function sendIosPushNotification($title = "", $message = "", $GetMyDeviceId = "", $pushparameter = "", $badge = 1, $apptype = "", $userToken = "") {
        try
        {
            ...
            fclose($fp);
            //return 1;
            $logquery = $this->db->query("insert notificationlog set status ='" . $result . "',deviceid ='" . $GetMyDeviceId . "',userToken='" . $userreg_id . "',deviceType='Ios',message='" . addslashes($IOSmessage) . "'");
            //     #Echo Result Of FireBase Server
            return $result;

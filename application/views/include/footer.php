          ...
          <footer class="main-footer">Twilight powered by <a href="https://twilightitsolutions.com/">Twilight IT Solutions</a></footer>
    <!-- /.control-sidebar -->
...
<div id="selectanyone" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content col-md-6">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            ...
            <div class="modal-body">
                <p>Please select anyone of the options </p>
            </div>
            <div class="modal-footer">

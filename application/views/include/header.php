...
<head>
  ...
  <?php } else { ?>
  <title>Twilight Centralized System<?php //echo (setting_all('website'))?setting_all('website'):'Dasboard';?></title>
  <?php } ?>
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/css/lightcase.css'); ?>" />
            ...
            <a href="<?php echo base_url(); ?>" class="logo">
             <?php $logo =  (setting_all('logo'))?setting_all('logo'):'logo.png'; ?>
              ...
              <span class="logo-mini">
                   ...
                   <!-- TL -->
                  <!--  <img class="thumb-image setpropileam" src="<?php //echo base_url();?>assets/images/t_logo.png" alt="User profile picture"> -->
                  <img class="thumb-image setpropileam" src="https://www.lespoton.com/portal/assets/images/t_logo.png" alt="User profile picture">
              </span>
              <!-- logo for regular state and mobile devices -->
              <span class="logo-lg">
                <!--<img src="<?php echo base_url().'assets/images/'.$logo; ?>" id="logo">-->
              <!-- TWILIGHT -->
              <img class="thumb-image setpropileam" src="<?php echo base_url();?>assets/images/twilight_1534402439.png" alt="User profile picture">
              </span>
            </a>
              ...
              <ul class="sidebar-menu">
                ...
                <?php $this->load->view("include/menu");?> 
                   ...
                   <?php if($this->session->userdata('user_details')[0]->user_type =='admin' || $this->session->userdata('user_details')[0]->user_type =='Admin') { ?>
                    ...
                    <!--<li class="<?=($this->router->method==="pigeon")?"active":"not-active"?>"> 
                        <a href="<?php echo base_url();?>user/pigeon"> <i class="fa fa-twitter"></i> <span>Pigeons</span></a>
                    </li>  -->
                    ...
                    <li  class="<?=($this->router->class==="setting")?"active":"not-active"?>">
                        <a href="<?php echo base_url();?>user/stickercolors"><i class="fa fa-sticky-note"></i> <span>Pigeon sticker colors</span></a>
                    </li>

                    <li  class="<?=($this->router->class==="setting")?"active":"not-active"?>">
                        <a href="<?php echo base_url();?>user/colors"><i class="fa fa-twitter"></i> <span>Pigeon colors</span></a>
                    </li>
                  <li class="<?=($this->router->class==="setting")?"active":"not-active"?>">
                        <a href="<?php echo base_url();?>user/birdcats"><i class="fa fa-building"></i> <span>Pigeon category</span></a>
                    </li>

                <?php if(isset($this->session->userdata('user_details')[0]->user_type) && $this->session->userdata('user_details')[0]->user_type == 'admin'){ ?>    
                    <li class="<?=($this->router->class==="setting")?"active":"not-active"?>">
                        <a href="<?php echo base_url("setting"); ?>"><i class="fa fa-gear fa-spin"></i> <span>Settings</span></a>
                    </li>
                 <?php } if($this->session->userdata('user_details')[0]->user_type =='admin' || $this->session->userdata('user_details')[0]->user_type =='Admin') { ?>
                    <li class="<?=($this->router->method==="logTable")?"active":"not-active"?>"> 
                        <a href="<?php echo base_url();?>user/logTable"> <i class="fa fa-gear"></i> <span>System Logs </span></a>
                    </li> 
                    <?php } ?>
              </ul>
            </section>
